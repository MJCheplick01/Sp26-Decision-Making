...
line1 + geom_histogram(aes(x=income),
                 fill="skyblue")  +
  scale_x_continuous(limits = c(0,200000) , labels=scales::dollar_format())
...
line1 +
  ...
  ggtitle("Density plot to show age dist of customer")
```
...
[]()
![UP map](https://ww1.up.edu/commencement/images/25parkingmaps)
![UP map2](https://ww1.up.edu/commencement/images/25parkingmaps)
library(ggplot2)
